...
DATA_FILE = os.path.join(BASE_DIR, 'combined_news.json')
IRENA_DATA_FILE = os.path.join(BASE_DIR, 'irena_news_load_more.json')
IRENA_TRANSLATED_FILE = os.path.join(BASE_DIR, 'irena_news_load_more_translated.json')
TRANSLATED_FILE = os.path.join(BASE_DIR, 'translator.json')  # 新增：翻译合并文件
